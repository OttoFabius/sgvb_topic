...
class sgvb_topic:
    def __init__(self, argdict):
        ...
        self.e = 1e-8
        self.rp = argdict['rp']
        self.K = argdict['HUe1'] #K is random projection dimensionality, for now equal to first hidden layer
...
class topic_model:
    def __init__(sgvb_topic, argdict):
    ...
    def createGradientFunctions_11(self):
